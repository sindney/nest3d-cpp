...
namespace nest
{
	...
	public:
		 ...
		 *	@param draw Indicates whether to draw meshes passed culling process.
		 ...
		 *	@see RenderTarget
		 */
		virtual void calculate(CameraNode *camera, bool draw, std::vector<MeshNode*> *result0, std::vector<MeshNode*> *result1, std::vector<MeshNode*> *result2) = 0;
